...
import net.iceburg.boot.starter.autoconfigure.AskJeevesAutoConfiguration;
...
public class AWSAutoConfigurationTests {
  ...
  private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
    .withConfiguration(AutoConfigurations.of(AskJeevesAutoConfiguration.class,AWSAutoConfiguration.class));
